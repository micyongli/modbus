      ...
      <Dialog open={open} onClose={e => this.props.onClose()}>
        ...
        <DialogContent className="tester-dlg-content">
          <TextField
            ...
            onChange={v => {
              this.setState({
                formVal: Object.assign({}, formVal, { devAdd: v.target.value })
              });
            }}
            label={"总线地址"}
          />
          ...
          <TextField
            ...
            onChange={v => {
              this.setState({
                formVal: Object.assign({}, formVal, {
                  register: v.target.value
                })
              });
            }}
            label={"寄存器"}
          ...
          <div style={{ marginTop: "10px" }}>
            <FormControlLabel
              ...
              control={
                <Radio
                  checked={formVal.regType === 0}
                  onChange={e => {
                    this.setState({
                      formVal: Object.assign({}, formVal, { regType: 0 })
                    });
                  }}
                />
              }
            ...
            <FormControlLabel
              ...
              control={
                <Radio
                  ...
                  onChange={e => {
                    this.setState({
                      formVal: Object.assign({}, formVal, { dataType: 0 })
                    });
                  }}
                />
              }
            ...
            <FormControlLabel
              ...
              control={
                <Radio
                  ...
                  onChange={e => {
                    this.setState({
                      formVal: Object.assign({}, formVal, { dataType: 1 })
                    });
                  }}
                />
              }
            ...
            <FormControlLabel
              ...
              control={
                <Radio
                  ...
                  onChange={e => {
                    this.setState({
                      formVal: Object.assign({}, formVal, { dataType: 2 })
                    });
                  }}
                />
              }
          ...
          <TextField
            ...
            onChange={v => {
              this.setState({
                formVal: Object.assign({}, formVal, { alph: v.target.value })
              });
            }}
            label={"系数"}
          />
          ...
          <div style={{ marginTop: "10px" }}>
              ...
              control={
                <Radio
                  ...
                  onChange={e => {
                    this.txt.value = " ";
                    this.setState({
                      formVal: Object.assign({}, formVal, { opType: 0 })
                    });
                  }}
                />
              }
            ...
            <FormControlLabel
              ...
              control={
                <Radio
                  disabled={formVal.regType === 1}
                  checked={formVal.opType === 1}
                  onChange={e => {
                    this.setState({
                      formVal: Object.assign({}, formVal, { opType: 1 })
                    });
                  }}
                />
              }
          ...
          <TextField
            ...
            onChange={v => {
              this.setState({
                formVal: Object.assign({}, formVal, { value: v.target.value })
              });
            }}
            label={"值"}
          />
